...
const char DASHBOARD_HTML[] PROGMEM = R"=====(
  ...
  <div class="page active" id="dash">
    ...
    <div class="sp-card">
      ...
      <div class="sp-row">
        <input type="number" id="spInput" step="0.5" value="22" onkeydown="if(event.key==='Enter')sendSp()">
    ...
    <div class="sp-card">
      ...
      <div class="sp-row">
        <input type="number" id="aqLimitInput" step="100" min="0" max="4095" value="2500" onkeydown="if(event.key==='Enter')sendAqLimit()">
    ...
    <div class="sp-card">
      ...
      <div class="sp-row">
        <input type="number" id="humLimitInput" step="5" min="0" max="100" value="65" onkeydown="if(event.key==='Enter')sendHumLimit()">
